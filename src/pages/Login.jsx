        ...
        <>
            <div className="flex flex-col w h-screen gap-2 items-center justify-center p-4">
                ...
                <FormProvider
                    ...
                    schema={schemaLogin}
                    clase="w-full md:w-1/4 gap-4 flex flex-col items-center"
                >
                    <Input label="Correo electrónico" name="email" type="email" required placeholder="Introduzca su correo electrónico" />
